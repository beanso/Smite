...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchSummary.god'
        db.add_column('Smitedb_matchsummary', 'god',
                      self.gf('django.db.models.fields.CharField')(default='He-bo', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MatchSummary.god'
        db.delete_column('Smitedb_matchsummary', 'god')
    ...
    models = {
        ...
        'Smitedb.matchsummary': {
            ...
            'god': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
