...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.matches'
        db.add_column('Smitedb_player', 'matches',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Smitedb.MatchSummary']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Player.matches'
        db.delete_column('Smitedb_player', 'matches_id')
        ...
        db.create_table('Smitedb_player_matches', (
            ...
            ('matchsummary', models.ForeignKey(orm['Smitedb.matchsummary'], null=False))
        ))
        db.create_unique('Smitedb_player_matches', ['player_id', 'matchsummary_id'])
    ...
    models = {
        ...
        'Smitedb.player': {
            ...
            'matches': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Smitedb.MatchSummary']"}),
